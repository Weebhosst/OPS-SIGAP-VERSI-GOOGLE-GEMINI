...
export const AdminCheckpoints: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-[#020817] pb-10 text-slate-100">
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 p-4 backdrop-blur-md"><div className="max-h-[92vh] w-full max-w-3xl space-y-4 overflow-y-auto rounded-3xl border border-slate-700/90 bg-[#0f172a] p-5 shadow-2xl shadow-black/50">
